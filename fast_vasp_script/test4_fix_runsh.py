...
def generate_run_script(material_id, vasp_path="/path/to/vasp"):
...
def process_abo3_materials(api_key, potcar_dir, max_materials=5, crystal_system="cubic", 
...
def main():
    ...
    vasp_path = ""  # Replace with your VASP executable path
